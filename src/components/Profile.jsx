...
const Profile = () => {
  ...
  async function getUser() {
    try {
      ...
      const res = await axios.get("https://snippetswap-api.onrender.com/user", {
  ...
  async function handleSubmit(e)
  {
    ...
    try{
      ...
      const res=await axios.patch(`https://snippetswap-api.onrender.com/user/${user._id}`,user,{headers:{Authorization:`Bearer ${token}`}})
      if(res.data)
      {
